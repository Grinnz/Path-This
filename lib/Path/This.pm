...
Path::This - Path to this source file
...
dynamic sub option so the file path will be calculated when the sub is called.
...
C<THISFILE> will export a constant.
...
will export a dynamic subroutine, and C<THISDIR> will export a constant.
